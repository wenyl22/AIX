...
wormholeEnable=(1 1 1)
VcsPerVnet=(2 2 2)
AdaptiveRouting=(0 1 1)
BufferPerCtrlVc=(2 2 2)
RoutingAlgorithm=(6 7 7)
CongestionSensor=(0 0 1)
EscapeRoutingAlgorithm=(-1 6 6)
Topology=("Cube_XYZ" "Cube_longrange" "Cube_longrange")
command_line="./build/NULL/gem5.opt configs/example/garnet_synth_traffic.py \
                ...
                --sim-cycles=200000 --best-effort --budget=18"
# File to store results
statsFile="cube_synth_evc_64.txt"
